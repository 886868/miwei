...
@Controller
public class TagMNGController extends BaseController {
    /**
     * LOG输出
     */
    private static Logger logger = Logger.getLogger(TagMNGController.class);
     ...
     * @throws IOException
     */
    @RequestMapping("/bookadmin/tagMng.do")
    public ModelAndView subjectMng(HttpServletRequest request)
            throws IOException {
        return new ModelAndView("tagMng");
    }  
     ...
     * @return
     */
    @RequestMapping(value = "/bookadmin/getTagList.do")
    @ResponseBody
    public String getTagList(HttpServletRequest request) {
        logger.debug(">>>> getTagList() start <<<<");
        
        GridDataModel<StoryTag> model = new GridDataModel<StoryTag>();
        
        List<StoryTag> lst = storyTagService.getAll();
     ...
     * @return
     */
    @RequestMapping(value = "/bookadmin/editTagList.do")
    @ResponseBody
